...
import (
	...
	"github.com/czh0526/perception/log"
...
type Database struct {
	diskdb chaindb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb chaindb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb chaindb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() chaindb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch chaindb.Batch, uncacher *cleaner) error {
