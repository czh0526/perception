...
import (
	...
	"github.com/czh0526/perception/common/prque"
...
type Sync struct {
	database chaindb.KeyValueReader   // Persistent database to check for existing entries
...
func NewSync(root common.Hash, database chaindb.KeyValueReader, callback LeafCallback, bloom *SyncBloom) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) Commit(dbw chaindb.KeyValueWriter) (int, error) {
